...
features:
  ...
  - title: Неограниченные дизайны
    details: Несколько строк, пользовательские иконки (ItemsAdder), градиенты MiniMessage и иерархия Vault.
  - title: Питомцы включены
    details: Позвольте волкам и кошкам ваших VIP-игроков унаследовать тот же стиль неймтега.
---
